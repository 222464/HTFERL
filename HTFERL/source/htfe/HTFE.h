...
namespace htfe {
	struct LayerDesc {
		...
		LayerDesc()
			...
			_spatialSparsity(1.01f / 81.0f), _spatialLifetimeSparsity(1.51f / 81.0f), _temporalSparsity(1.01f / 81.0f), _temporalLifetimeSparsity(1.51f / 81.0f), _dutyCycleDecay(0.1f),
			_spatialAlpha(0.005f), _predictiveAlpha(0.01f), _lateralAlpha(0.01f), _feedBackAlpha(0.01f), _reconstructionAlpha(0.1f),
			...
			_dominationFactor(1.0f), _lifetimeSparsityCorrectionFactor(0.2f), _boostIntensity(5.0f)
		{}
	};
