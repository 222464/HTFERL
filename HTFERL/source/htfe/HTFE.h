...
namespace htfe {
	struct LayerDesc {
		...
		LayerDesc()
			...
			_spatialSparsity(2.01f / 81.0f), _spatialLifetimeSparsity(2.01f / 81.0f), _temporalSparsity(2.01f / 81.0f), _temporalLifetimeSparsity(2.01f / 81.0f), _dutyCycleDecay(0.1f),
			_spatialAlpha(0.02f), _predictiveAlpha(0.04f), _lateralAlpha(0.02f), _feedBackAlpha(0.04f), _reconstructionAlpha(0.1f),
